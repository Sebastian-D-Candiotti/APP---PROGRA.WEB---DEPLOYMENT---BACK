...
const findOne = async (req,res) => {
    ...
    return sendResults(result, res, "No se han encontrado producto.")
}
...
const create = async (req,res) => {
    ...
    return sendResults(createdObj, res, "Error al crear el producto.")
}
...
const update = async (req,res) => {
    ...
    return sendResults(updatedObj, res, "Error al actualizar el productos.")
}
